						...
						<ol class="breadcrumb mb-0">
							...
							<li><a id="dropdownMenu2" href="#" data-toggle="dropdown"
								...
								<ul aria-labelledby="dropdownMenu2"
									...
									<li><a href="#"><i class="fa fa-table mr-5"></i>
											តារាង</a></li>
									<li><a href="#"><i class="ti-plus mr-5"></i>
											បញ្ចូលថ្មី</a></li>
									<li><a href="#"><i class="ti-pencil mr-5"></i> កំណែប្រែថ្មី</a></li>
								</ul></li>
								...
								<tbody>
									<tr>
										...
										<td class="text-center"><a data-toggle="modal"
														data-target=".bs-example-modal-animation" class="text-danger"><i class="ti-close"></i></a></td>
										<td>
