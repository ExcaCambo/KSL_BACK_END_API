...
<div id='header'>
  <div class="swagger-ui-wrap">
    <a id="logo" href="http://swagger.io">KhmerSlide API</a>
    <form id='api_selector'>
     <!--  <div class='input'><input placeholder="http://example.com/api" id="input_baseUrl" name="baseUrl" type="text"/></div>
      <div class='input'><input placeholder="api_key" id="input_apiKey" name="apiKey" type="text"/></div> -->
      <div class='input'><input placeholder="${pageContext.request.contextPath}/api/user" value="${pageContext.request.contextPath}/api/user" id="input_baseUrl" name="baseUrl" type="hidden"/></div>
